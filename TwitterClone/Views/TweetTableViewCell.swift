...
class TweetTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        actionsStackView.addArrangedSubview(retweetButton)
    ...
    func configure(with displayName: String, username: String, tweetTextContent: String, avatarPath: String) {
    ...
    private func configureConstraints() {
        ...
        let tweetTextContentLabelConstraints = [
            ...
            tweetTextContentLabel.bottomAnchor.constraint(equalTo: actionsStackView.topAnchor,constant: -10)
        ]
        
        let actionsStackViewConstraints = [
            actionsStackView.leadingAnchor.constraint(equalTo: displayNameLabel.leadingAnchor),
            actionsStackView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -20),
            actionsStackView.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: -10),
        ]
        ...
        NSLayoutConstraint.activate(actionsStackViewConstraints)
    }
